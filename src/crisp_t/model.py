...
class Corpus(BaseModel):
    ...
    """
    documents: list[Document] = Field(default_factory=list, description="List of documents in the corpus.")
    metadata: dict = Field(default_factory=dict, description="Metadata associated with the corpus.")
    id: str = Field(..., description="Unique identifier for the corpus.")
    score: float = Field(0.0, description="Score associated with the corpus.")
    name: Optional[str] = Field(None, description="Name of the corpus.")
    description: Optional[str] = Field(None, description="Description of the corpus.")
