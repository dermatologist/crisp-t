...
**TL;DR** *CRISP-T is a qualitative research method and a toolkit to perform textual (Ex: topic modeling) and numeric (Ex: decision trees) analysis for computational triangulation and sense-making using large language models.*
