...
[Full Changelog](https://github.com/dermatologist/crisp-t/compare/v2.3.1...HEAD)

**Merged pull requests:**

- Feature/fix copilot 1 [\#102](https://github.com/dermatologist/crisp-t/pull/102) ([dermatologist](https://github.com/dermatologist))
- Update README to replace image link and add crisp-webui.jpg [\#97](https://github.com/dermatologist/crisp-t/pull/97) ([dermatologist](https://github.com/dermatologist))
- Feature/fix readme update deps 1 [\#95](https://github.com/dermatologist/crisp-t/pull/95) ([dermatologist](https://github.com/dermatologist))
- Add dynamic model loading to crisp-ui with comprehensive fallback list [\#93](https://github.com/dermatologist/crisp-t/pull/93) ([Copilot](https://github.com/apps/copilot-swe-agent))
- Revise UI section for GitHub Copilot SDK [\#91](https://github.com/dermatologist/crisp-t/pull/91) ([dermatologist](https://github.com/dermatologist))
- Feature/improve skill cli 1 [\#90](https://github.com/dermatologist/crisp-t/pull/90) ([dermatologist](https://github.com/dermatologist))
...
- Bump cryptography from 46.0.4 to 46.0.5 [\#85](https://github.com/dermatologist/crisp-t/pull/85) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- Bump python-multipart from 0.0.21 to 0.0.22 [\#68](https://github.com/dermatologist/crisp-t/pull/68) ([dependabot[bot]](https://github.com/apps/dependabot))
...
## [v2.3.1](https://github.com/dermatologist/crisp-t/tree/v2.3.1) (2026-02-16)

[Full Changelog](https://github.com/dermatologist/crisp-t/compare/v2.3.0...v2.3.1)

**Closed issues:**

- Add additional models to crisp-ui \(Web UI - NEW!\) [\#92](https://github.com/dermatologist/crisp-t/issues/92)
- Build a UI for CRISP package that uses the new COPILOT-SDK to interact with CRISP using CLI and display results. [\#86](https://github.com/dermatologist/crisp-t/issues/86)

## [v2.3.0](https://github.com/dermatologist/crisp-t/tree/v2.3.0) (2026-02-11)

[Full Changelog](https://github.com/dermatologist/crisp-t/compare/v2.2.1...v2.3.0)
