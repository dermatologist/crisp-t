...
Welcome to `crisp-t` contributor's guide.
...
If you experience bugs or general issues with `crisp-t`, please have a look
...
You can help improve `crisp-t` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`crisp-t` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `crisp-t`'s files. While this mechanism can
...
```
conda create -n crisp-t python=3 six virtualenv pytest pytest-cov
conda activate crisp-t
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/crisp-t.git
   cd crisp-t
   ```
...
5. Install [pre-commit]:
   ...
   `crisp-t` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/crisp-t
[issue tracker]: https://github.com/<USERNAME>/crisp-t/issues
